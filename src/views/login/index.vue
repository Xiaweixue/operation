        ...
        <el-card class="login">
            ...
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="demo-ruleForm">
                ...
                <el-form-item prop="password">
                    <el-input type="password" v-model.trim="ruleForm.password" placeholder="请输入密码" autocomplete="off">
                    </el-input>
                </el-form-item>
                <el-form-item label="" prop="code">
                    <el-input v-model="ruleForm.code" prefix-icon="lj-icon-yanzhengma" autocomplete="off"
                        autocapitalize="off" spellcheck="false" @keyup.enter.native="submit"
                        style="float:left;width:240px;" placeholder="请填写验证码"></el-input>
                    <div style="width:110px;float:right;height:40px;">
                        <img :src="this.img" alt="" @click="acquireVerification">
                    </div>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" class="log" @click="login('ruleForm')">登录</el-button>
